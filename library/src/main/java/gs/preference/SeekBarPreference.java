...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(
        ...
        super(new ContextThemeWrapper(context, R.style.Preference_SeekBarPreference), attrs, defStyleAttr, defStyleRes);

        init(context, attrs, defStyleAttr, defStyleRes);
    }

    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(new ContextThemeWrapper(context, R.style.Preference_SeekBarPreference), attrs, defStyleAttr);
